  ...
  return (
    <div>
      ...
      <div className=" py-[30px] px-[15px]">
        ...
        <p className="text-[rgb(91,102,113)] text-[16.75px] text-center leading-[26.25px] max-w-180 mb-[30px] md:max-w-[600px] mx-auto">
      ...
      <div className="py-[60px] px-[15px]">
        ...
        <div className="flex flex-col items-center gap-6  border-[rgb(239,241,250)] md:grid md:grid-cols-2 lg:grid-cols-4 md:gap-x-6 mx-[15px]">
