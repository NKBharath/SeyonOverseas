    ...
    <div>
      ...
      <div className="mt-[30px]">
        <div className=" px-[15px]">
          ...
          <h2 className="text-[rgb(24,31,37)] font-bold text-center text-[26.25px] leading-[30px] mb-2 mt-20">
            Core Services
          </h2>
          <p className="text-[rgb(91,102,113)] text-[15px] text-center leading-[22px] mb-[30px] md:max-w-[600px] mx-auto">
            Each service is designed to address a critical aspect of your study
            abroad process
          </p>
          <div className="px-[15px] grid md:grid-cols-2 lg:grid-cols-3 md:gap-x-8 xl:grid-cols-4">
        ...
        <div className="bg-[#f0f7ff] px-[15px] py-[60px] ">
          <h2 className="text-[rgb(24,31,37)] text-[28px] font-bold text-center leading-[33.75px] mb-[45px]">
